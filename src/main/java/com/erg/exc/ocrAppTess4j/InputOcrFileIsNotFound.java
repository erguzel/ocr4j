...
public class InputOcrFileIsNotFound extends BaseGeneralException {
    /**
     ...
     */
    public InputOcrFileIsNotFound(String whatHappened, Boolean endGame, String causeReference, String resultReference) {
