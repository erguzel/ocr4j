...
public class OutputOcrDirectoryNotFound extends BaseGeneralException {
    /**
     ...
     */
    public OutputOcrDirectoryNotFound(String whatHappened, Boolean endGame, String causeReference, String resultReference) {
